...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/tripleten-com/ai-system-engineering-curriculum-sprint-1-task-1-4/tree/main)
...
For Task 1.4, `poe verify` runs readiness, smoke tests, the end-to-end workflow, load-harness
checks, and answer/protected-path checks.

The supplied `poe load-test` profile uses 20 users, a spawn rate of 5 users/second, and a 30-second run.
...
Use the Task 1.4 lesson to decide what evidence to collect. This README covers local setup and
